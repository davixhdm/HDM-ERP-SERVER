...
router.use('/crm', planLimit('crm'), require('./crmRoutes'));
router.use('/projects', planLimit('projects'), require('./projectRoutes'));
...
router.use('/assets', planLimit('assets'), require('./assetRoutes'));
...
router.use('/communications', planLimit('communications'), require('./communicationsRoutes'));
